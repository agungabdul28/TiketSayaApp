...
public class RegisterTrhee extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_trhee);
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            storageReference1.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onComplete(@NonNull Task<Uri> task) {
                                    // berpindah activity
                                    Intent gotosuccess = new Intent(RegisterTrhee.this,SuccesRegister.class);
...
//                            startActivity(gotosuccess);
        ...
        btn_back.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent backtoprev = new Intent(RegisterTrhee.this,RegisterOne.class);
